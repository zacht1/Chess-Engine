...
public class MoveTest {
    ...
    public void constructorTestBasicMove() {
        Move testMove = new Move(testBoard, 7,2,7,4);
    ...
    public void constructorTestCapture() {
        ...
        Move testMove = new Move(testBoard, 3,3,4,5);
    ...
    public void constructorTestEnPassant() {
        ...
        Move testMove = new Move(testBoard, 4, 4, 5, 3);
    ...
    public void constructorTestPromotionMove() {
        ...
        Move testMove = new Move(testBoard, 8,7,8,8);
    ...
    public void constructorTestKingSideCastle() {
        ...
        Move testMove = new Move(testBoard, 5,1,7,1);
    ...
    public void constructorTestQueenSideCastle() {
        ...
        Move testMove = new Move(testBoard, 5,8,3,8);
    ...
    public void formatMoveTest() {
        Move testMove = new Move(testBoard, 8,2,8,3);
        ...
        Move testCapture = new Move(testBoard, 6,6,5,4);
